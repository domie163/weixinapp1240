...
const routes = [
	...
	// 信息中心路由
	{
		path: '/information_center/table',
		name: 'information_center_table',
		component: () => import('../views/information_center/table.vue'),
		meta: {
			index: 0,
			title: '信息中心列表'
		}
	...
	{
		path: '/information_center/view',
		name: 'information_center_view',
		component: () => import('../views/information_center/view.vue'),
		meta: {
			index: 0,
			title: '信息中心详情'
		}
