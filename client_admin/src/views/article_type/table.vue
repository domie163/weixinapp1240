				...
				<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
					<el-col :xs="24" :sm="24" :lg="24" class="search_btn_1">
						<el-form-item>
							...
							<el-button v-if="user_group == '管理员' || $check_action('/article_type/table','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
							<router-link v-if="user_group == '管理员' || $check_action('/article_type/view')" 
