		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="学生学号" prop="student_id">
												<el-input id="student_id" v-model="form_sub['student_id']" placeholder="请输入学生学号"
				...
				<el-form-item label="学生姓名" prop="student_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','student_name')) || (!form_sub['student_users_id'] && $check_field('add','student_name'))"></el-input>
					<div v-else-if="$check_field('get','student_name')">{{form_sub['student_name']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','student_gender') || $check_field('add','student_gender') || $check_field('set','student_gender')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="学生性别" prop="student_gender">
								<el-select id="student_gender" v-model="form_sub['student_gender']"
						v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','student_gender')) || (!form_sub['student_users_id'] && $check_field('add','student_gender'))">
					...
					<div v-else-if="$check_field('get','student_gender')">{{form_sub['student_gender']}}</div>
								...
								<el-col v-if="user_group === '管理员' || $check_field('get','student_department') || $check_field('add','student_department') || $check_field('set','student_department')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="学生院系" prop="student_department">
												<el-input id="student_department" v-model="form_sub['student_department']" placeholder="请输入学生院系"
							  v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','student_department')) || (!form_sub['student_users_id'] && $check_field('add','student_department'))"></el-input>
					<div v-else-if="$check_field('get','student_department')">{{form_sub['student_department']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="学生专业" prop="major">
												<el-input id="major" v-model="form_sub['major']" placeholder="请输入学生专业"
							  v-if="user_group === '管理员' || (form_sub['student_users_id'] && $check_field('set','major')) || (!form_sub['student_users_id'] && $check_field('add','major'))"></el-input>
			...
			return {
				...
				disabledObj:{
								"student_id_isDisabled": false,
										...
										"student_department_isDisabled": false,
