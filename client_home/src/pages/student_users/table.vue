          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="学生学号" name="student_id">
                      <uni-easyinput type="text" v-model="query.student_id" placeholder="学生学号" />
                    </uni-forms-item>
                    <uni-forms-item label="学生姓名" name="student_name">
                      <uni-easyinput type="text" v-model="query.student_name" placeholder="学生姓名" />
                    </uni-forms-item>
                      <uni-forms-item label="学生院系" name="student_department">
                      <uni-easyinput type="text" v-model="query.student_department" placeholder="学生院系" />
                    </uni-forms-item>
                  </uni-forms>
              <!-- /搜索栏 -->
                            ...
                            <span>学生学号</span>
								...
								<text>
									{{ o["student_id"] }}
													...
													<view v-if="0 && $check_field('get','student_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>学生姓名</span>
                          </view>
								...
								<text>
									{{ o["student_name"] }}
													...
													<view v-if="0 && $check_field('get','student_gender')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>学生性别</span>
                          </view>
								...
								<text>
									{{ o["student_gender"] }}
													...
													<view v-if="0 && $check_field('get','student_department')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>学生院系</span>
                          </view>
											<view class="diy_field diy_text text">
								<text>
									{{ o["student_department"] }}
								</text>
							</view>
										</view>
					</view>
													<view v-if="0 && $check_field('get','major')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>学生专业</span>
                          </view>
	...
	export default {
		...
		data() {
			return {
				...
				list: [],
                                    // 学生性别列表
                list_student_gender: [{value:"",text:"全部"}],
                        			}
		},
		methods: {
          search() {
