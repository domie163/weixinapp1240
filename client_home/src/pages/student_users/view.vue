          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','student_name') || $check_field('add','student_name') || $check_field('set','student_name')" label="学生姓名" name="student_name">
                                <uni-easyinput type="text" v-model="form['student_name']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','student_name')) || (!form['student_users_id'] && $check_field('add','student_name'))" :disabled="disabledObj['student_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','student_gender') || $check_field('add','student_gender') || $check_field('set','student_gender')" label="学生性别" name="student_gender">
                  ...
                  v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','student_gender')) || (!form['student_users_id'] && $check_field('add','student_gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','student_department') || $check_field('add','student_department') || $check_field('set','student_department')" label="学生院系" name="student_department">
                                <uni-easyinput type="text" v-model="form['student_department']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','student_department')) || (!form['student_users_id'] && $check_field('add','student_department'))" :disabled="disabledObj['student_department_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','student_department')">
                  {{ form['student_department'] }}
                </text>
                            </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','major') || $check_field('add','major') || $check_field('set','major')" label="学生专业" name="major">
                                <uni-easyinput type="text" v-model="form['major']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','major')) || (!form['student_users_id'] && $check_field('add','major'))" :disabled="disabledObj['major_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','major')">
                  {{ form['major'] }}
                </text>
                            </uni-forms-item>
